...
export const FeaturesCard = () => {
  return (
    <section className='grid lg:grid-cols-3 max-w-fit gap-y-4 lg:gap-y-24 w-full place-content-center lg:space-x-4'>
      ...
      {cards.map((card) => (
        <Card key={card.title} className='max-w-sm relative overflow-hidden'>
